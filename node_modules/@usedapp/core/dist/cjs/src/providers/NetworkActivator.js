...
function NetworkActivator() {
    var _this = this;
    var _a = hooks_1.useEthers(), activate = _a.activate, account = _a.account, connectedChainId = _a.chainId, active = _a.active, connector = _a.connector;
    var _b = context_1.useConfig(), supportedChains = _b.supportedChains, readOnlyChainId = _b.readOnlyChainId, readOnlyUrls = _b.readOnlyUrls, autoConnect = _b.autoConnect;
    react_1.useEffect(function () {
        var eagerConnect = function () { return __awaiter(_this, void 0, void 0, function () {
            var injected;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        injected = new injected_connector_1.InjectedConnector({ supportedChainIds: supportedChains });
                        return [4 /*yield*/, injected.isAuthorized()];
                    case 1:
                        if (_a.sent()) {
                            activate(injected);
                        }
