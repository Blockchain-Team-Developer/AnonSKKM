...
describe('Chain helpers', () => {
    ...
    it('getExplorerAddressLink', () => {
        ...
        expect(getExplorerAddressLink(address, ChainId.Songbird)).to.eq('https://songbird-explorer.flare.network/address/0xC7095A52C403ee3625Ce8B9ae8e2e46083b81987');
        expect(getExplorerAddressLink(address, ChainId.MoonbaseAlpha)).to.eq('https://moonbase.moonscan.io/address/0xC7095A52C403ee3625Ce8B9ae8e2e46083b81987');
    });
    it('getExplorerTransactionLink', () => {
        ...
        expect(getExplorerTransactionLink(tx, ChainId.Songbird)).to.eq('https://songbird-explorer.flare.network/tx/0x5d53558791c9346d644d077354420f9a93600acf54eb6a279f12b43025392c3a');
        expect(getExplorerTransactionLink(tx, ChainId.MoonbaseAlpha)).to.eq('https://moonbase.moonscan.io/tx/0x5d53558791c9346d644d077354420f9a93600acf54eb6a279f12b43025392c3a');
    });
});
